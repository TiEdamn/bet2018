                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form action="match/{{ $match->id }}" method="POST" class="form-inline">
                            ...
                            <input type="text" name="home_score" value="{{ $match->home_score != null ? $match->home_score : '' }}" placeholder="{{ $match->home->name }}" class="form-control">
                            <input type="text" name="visitor_score" value="{{ $match->visitor_score != null ? $match->visitor_score : '' }}" placeholder="{{ $match->visitor->name }}" class="form-control">
